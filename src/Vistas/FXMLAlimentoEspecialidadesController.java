 ...
 * @author Santi
 */
public class FXMLAlimentoEspecialidadesController implements Initializable {
    ...
    private FXMLEspecialidadesController controlador;

    Sistema sis;
    private int id;

    public void setController(FXMLEspecialidadesController controlador) {
